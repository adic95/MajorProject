...
// Cross Module References
	...
	MAJORPROJECT_API UFunction* Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound();
	MAJORPROJECT_API UFunction* Z_Construct_UFunction_AMPGameModeBase_GetPlayerScore();
	MAJORPROJECT_API UFunction* Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave();
...
// End Cross Module References
	void AMPGameModeBase::StaticRegisterNativesAMPGameModeBase()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "GetPlayerRound", &AMPGameModeBase::execGetPlayerRound },
			{ "GetPlayerScore", &AMPGameModeBase::execGetPlayerScore },
			{ "GetPlayerWave", &AMPGameModeBase::execGetPlayerWave },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics
	{
		struct MPGameModeBase_eventGetPlayerRound_Parms
		{
			int32 ReturnValue;
		};
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MPGameModeBase_eventGetPlayerRound_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Base/MPGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMPGameModeBase, nullptr, "GetPlayerRound", sizeof(MPGameModeBase_eventGetPlayerRound_Parms), Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics
	{
		struct MPGameModeBase_eventGetPlayerWave_Parms
		{
			int32 ReturnValue;
		};
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MPGameModeBase_eventGetPlayerWave_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Base/MPGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AMPGameModeBase, nullptr, "GetPlayerWave", sizeof(MPGameModeBase_eventGetPlayerWave_Parms), Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMPGameModeBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AMPGameModeBase_GetPlayerRound, "GetPlayerRound" }, // 2775681772
		{ &Z_Construct_UFunction_AMPGameModeBase_GetPlayerScore, "GetPlayerScore" }, // 2579297230
		{ &Z_Construct_UFunction_AMPGameModeBase_GetPlayerWave, "GetPlayerWave" }, // 3463054554
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMPGameModeBase, 4162958079);
